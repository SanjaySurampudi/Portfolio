            ...
            <div className={styles.infoDetails}>
              ...
              <div className={styles.infoItem}>
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/sanjay-siva-kumar-surampudi-a4790831a" target="_blank" rel="noopener noreferrer" className={styles.infoValue}>linkedin.com/in/sanjay</a>
                </div>
              </div>
